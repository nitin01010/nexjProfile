    ...
    return (
        <div className='  flex flex-wrap sm:flex-nowrap  gap-2 p-10 '>
            <div className='  p-2 flex justify-center   sm:w-[50%] w-[100%]'>
                <img src='https://media.licdn.com/dms/image/D5603AQGSczvYbV76iA/profile-displayphoto-shrink_200_200/0/1702487580138?e=1715817600&v=beta&t=IijMuqqgvPI244pvOFEnY2FvDdqSmYU90y0EIkuJD8A' className="object-contain h-96 rounded-md shadow-md  ..." />
            </div>
